# Provides the ability to set or clear the authentication passwords
# for the TPM.  At this time you can clear a set password but
# cannot change it another value.
#
# To use this module, set tpm2::take_ownership to true in hiera
# and set the parameters in hiera to override the defaults.
#
# @param owner The desired state fo the owner authentication.
#
# @param endorsement The desired state fo the endorsement authentication.
#
# @param lock The desired state fo the lockout authentication.
#
# @param owner_auth The password word for owner authentication.
#
# @param lock_auth The password word for lockout authentication.
#
# @param endorsement_auth The password word for endorsement authentication.
#
# @param in_hex Whether or not the passwords are in Hex.
#
# @example
#
